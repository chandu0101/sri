...
import chandu0101.scalajs.sri.mobile.components.ios.SwitchIOS
import chandu0101.scalajs.sri.mobile.examples.uiexplorer.{UIExample, UIExplorerPage}
...
object ModalExample extends UIExample {
  ...
  object Button {
    ...
    def apply(onPress: () => Unit, style: js.Dictionary[Any] = js.Dictionary(), key: UndefOr[String] = js.undefined, ref: RefType = null)(children: ReactNode) = createElementWithChildren(factory, Props(onPress, style), key = key, ref = ref)(children)
