...
object TextInputExample extends UIExample {
  ...
  object WithLabel {
    ...
    def apply(label: String, key: UndefOr[String] = js.undefined, ref: js.Function = null)(children: ReactNode*) = createElementWithChildren(factory, label, key = key, ref = ref)(children: _*)
