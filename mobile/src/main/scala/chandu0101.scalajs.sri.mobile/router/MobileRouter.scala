...
object MobileRouter {
  ...
  object MobileRouterContext {
    ...
    def apply(ctrl: MobileRouterCtrl, key: U[String] = js.undefined, ref: RefType = null)(children: ReactNode*) = createElementWithChildren(factory, Props(ctrl), key = key, ref = ref)(children: _*)
