...
/**
 *
 * its copy of scalatags styles and modified for our needs
 * https://github.com/lihaoyi/scalatags/blob/df74f122380da64d79944be0363f72fa90d3fbcf/scalatags/shared/src/main/scala/scalatags/generic/Styles.scala
 */
...
object WebStylesMisc {

  /**
   * A Style that has an auto value
   */
  final class AutoStyle(name: String) extends WebStyle(name) {
   ...
   */
  final class NoneOpenStyle(name: String) extends WebStyle(name) {
   ...
   */
  final class NormalOpenStyle(name: String) extends WebStyle(name) {
    @inline final def normal = this := "normal"
  }

  final class MultiImageStyle(name: String) extends WebStyle(name)

  sealed class CurrentColor(name: String) extends WebStyle(name) {
    @inline final def currentColor = this -> "currentColor"
  }

  sealed class OutlineStyle(name: String) extends WebStyle(name) {
    /**
  ...
  final class Overflow(name: String) extends WebStyle(name) {
    /**
  ...
  final class PageBreak(name: String) extends WebStyle(name) {
    /**
  ...
  final class BorderRadius(name: String) extends WebStyle(name)

  trait MarginAuto extends WebStyle {
    /**
  ...
  final class BorderWidth(name: String) extends WebStyle(name) {
  ...
  final class MultiTimeStyle(name: String) extends WebStyle(name)

}

trait WebStyleAttrs {

  import chandu0101.scalajs.sri.web.styles.WebStylesMisc._
   ...
   * MDN
   */
  object backgroundAttachment extends WebStyle("backgroundAttachment") {
    /**
   ...
   * MDN
   */
  final val background = new WebStyle("background")
   ...
   * MDN
   */
  final val backgroundRepeat = new WebStyle("backgroundRepeat")
   ...
   * MDN
   */
  final val backgroundPosition = new WebStyle("backgroundPosition")
   ...
   * MDN
   */
  final val backgroundColor = new WebStyle("backgroundColor")
   ...
   * MDN
   */
  object backgroundOrigin extends WebStyle("backgroundOrigin") {
    /**
   ...
   * MDN
   */
  object backgroundClip extends WebStyle("backgroundClip") {
    /**
     * The background extends to the outside edge of the border (but underneath
     * the border in z-ordering).
     *
   ...
   * MDN
   */
  object backgroundSize extends WebStyle("backgroundSize") {
    /**
   ...
   * MDN
   */
  final val backgroundImage = new MultiImageStyle("backgroundImage")
   ...
   * MDN
   */
  final val borderTopColor = new WebStyle("borderTopColor")
   ...
   * MDN
   */
  final val borderStyle = new BorderStyle("borderStyle")
   ...
   * MDN
   */
  final val borderTopStyle = new BorderStyle("borderTopStyle")
   ...
   * MDN
   */
  final val borderRightStyle = new BorderStyle("borderRightStyle")
   ...
   * MDN
   */
  final val borderRightWidth = new BorderWidth("borderRightWidth")
   ...
   * MDN
   */
  final val borderTopRightRadius = new BorderRadius("borderTopRightRadius")
   ...
   * MDN
   */
  final val borderBottomLeftRadius = new BorderRadius("borderBottomLeftRadius")
   ...
   * MDN
   */
  final val borderRightColor = new WebStyle("borderRightColor")
   ...
   * MDN
   */
  final val borderBottom = new WebStyle("borderBottom")
  /**
   ...
   * MDN
   */
  final val border = new WebStyle("border")
   ...
   * MDN
   */
  final val borderBottomWidth = new BorderWidth("borderBottomWidth")
   ...
   * MDN
   */
  final val borderLeftColor = new WebStyle("borderLeftColor")
   ...
   * MDN
   */
  final val borderBottomColor = new WebStyle("borderBottomColor")
   ...
   * MDN
   */
  object borderCollapse extends WebStyle("borderCollapse") {
    /**
   ...
   * MDN
   */
  final val borderLeft = new WebStyle("borderLeft")
  /**
   ...
   * MDN
   */
  final val borderLeftStyle = new BorderStyle("borderLeftStyle")
   ...
   * MDN
   */
  final val borderRight = new WebStyle("borderRight")
   ...
   * MDN
   */
  final val borderBottomStyle = new BorderStyle("borderBottomStyle")
  /**
   * The border-left-width CSS property sets the width of the left border of a box.
   *
   * MDN
   */
  final val borderLeftWidth = new BorderWidth("borderLeftWidth")
  /**
   * The border-top-width CSS property sets the width of the top border of a box.
   *
   * MDN
   */
  final val borderTopWidth = new BorderWidth("borderTopWidth")
  /**
   ...
   * MDN
   */
  final val borderTop = new WebStyle("borderTop")
   ...
   * MDN
   */
  object borderSpacing extends WebStyle("borderSpacing") {
    def :=(horizontal: String, vertical: String): WebStylePair = this := s"$horizontal $vertical"
  }
   ...
   * MDN
   */
  final val borderRadius = new WebStyle("borderRadius")
   ...
   * MDN
   */
  final val borderWidth = new WebStyle("borderWidth")
   ...
   * MDN
   */
  final val borderBottomRightRadius = new BorderRadius("borderBottomRightRadius")
   ...
   * MDN
   */
  final val borderTopLeftRadius = new BorderRadius("borderTopLeftRadius")
   ...
   * MDN
   */
  final val borderColor = new WebStyle("borderColor")
   ...
   * MDN
   */
  object boxSizing extends WebStyle("boxSizing") {
    /**
   ...
   * MDN
   */
  object clip extends WebStyle("clip") {
   ...
   * MDN
   */
  object cursor extends WebStyle("cursor") {
   ...
   * MDN
   */
  object float extends WebStyle("cssFloat") {
    /**
   ...
   * MDN
   */
  object direction extends WebStyle("direction") {
    /**
   ...
   * MDN
   */
  object display extends WebStyle("display") {
    /**
   ...
   * MDN
   */
  object pointerEvents extends WebStyle("pointerEvents") {
    /**
   ...
   * MDN
   */
  object listStyleImage extends WebStyle("listStyleImage") {
   ...
   * MDN
   */
  object listStylePosition extends WebStyle("listStylePosition") {
    /**
  ...
  object wordWrap extends WebStyle("wordWrap") {
    /**
   ...
   * MDN
   */
  final val opacity = new WebStyle("opacity")
   ...
   * MDN
   */
  final val maxWidth = new WebStyle("maxWidth")
   ...
   * MDN
   */
  object verticalAlign extends WebStyle("verticalAlign") {
    /**
   ...
   * MDN
   */
  final val overflow = new Overflow("overflow")
   ...
   * MDN
   */
  object mask extends WebStyle("mask") {
    @inline final def none = this := "none"
   ...
   * MDN
   */
  object emptyCells extends WebStyle("emptyCells") {
    /**
   ...
   * MDN
   */
  final val height = new AutoStyle("height")
   ...
   * MDN
   */
  final val paddingRight = new WebStyle("paddingRight")
   ...
   * MDN
   */
  final val paddingTop = new WebStyle("paddingTop")
   ...
   * MDN
   */
  final val paddingLeft = new WebStyle("paddingLeft")
   ...
   * MDN
   */
  final val padding = new WebStyle("padding")
   ...
   * MDN
   */
  final val paddingBottom = new WebStyle("paddingBottom")
   ...
   * MDN
   */
  final val right = new AutoStyle("right")
   ...
   * MDN
   */
  final val lineHeight = new NormalOpenStyle("lineHeight")
   ...
   * MDN
   */
  final val left = new AutoStyle("left")
   ...
   * MDN
   */
  object listStyleType extends WebStyle("listStyleType") {
    /**
   ...
   * MDN
   */
  final val listStyle = new WebStyle("listStyle")
   ...
   * MDN
   */
  final val overflowY = new Overflow("overflowY")
   ...
   * MDN
   */
  object captionSide extends WebStyle("captionSide") {
    /**
   ...
   * MDN
   */
  final val boxShadow = new WebStyle("boxShadow")
   ...
   * MDN
   */
  object position extends WebStyle("position") {
    /**
  ...
  object quotes extends WebStyle("quotes") {
    /**
  ...
  object tableLayout extends WebStyle("tableLayout") {
    /**
   ...
   * MDN
   */
  object fontSize extends WebStyle("fontSize") {
   ...
   * MDN
   */
  final val fontSizeAdjust = new WebStyle("fontSizeAdjust")
   ...
   * MDN
   */
  final val fontFamily = new WebStyle("fontFamily")
   ...
   * MDN
   */
  object fontWeight extends WebStyle("fontWeight") {
    /**
   ...
   * MDN
   */
  final val font = new WebStyle("font")
   ...
   * MDN
   */
  final val fontFeatureSettings = new WebStyle("fontFeatureSettings")
   ...
   * MDN
   */
  object fontStyle extends WebStyle("fontStyle") {
    /**
   ...
   * MDN
   */
  object clear extends WebStyle("clear") {
    /**
   ...
   * MDN
   */
  final val marginBottom = new AutoStyle("marginBottom")
   ...
   * MDN
   */
  final val marginRight = new WebStyle("marginRight") with MarginAuto
   ...
   * MDN
   */
  final val marginTop = new WebStyle("marginTop") with MarginAuto
   ...
   * MDN
   */
  final val marginLeft = new WebStyle("marginLeft") with MarginAuto
   ...
   * MDN
   */
  object margin extends WebStyle("margin") {
    /**
     * auto is replaced by some suitable value, e.g. it can be used for
     * centering of blocks.
     *
   ...
   * MDN
   */
  final val top = new AutoStyle("top")
   ...
   * MDN
   */
  final val width = new AutoStyle("width")
   ...
   * MDN
   */
  final val bottom = new AutoStyle("bottom")
   ...
   * MDN
   */
  final val letterSpacing = new NormalOpenStyle("letterSpacing")
   ...
   * MDN
   */
  final val maxHeight = new NoneOpenStyle("maxHeight")
   ...
   * MDN
   */
  final val minWidth = new WebStyle("minWidth")
   ...
   * MDN
   */
  final val minHeight = new WebStyle("minHeight")
   ...
   * MDN
   */
  final val outline = new WebStyle("outline")
   ...
   * MDN
   */
  final val outlineStyle = new OutlineStyle("outlineStyle")
   ...
   * MDN
   */
  object outlineWidth extends WebStyle("outlineWidth") {
    /**
   ...
   * MDN
   */
  object outlineColor extends WebStyle("outlineColor") {
    /**
   ...
   * MDN
   */
  final val overflowX = new Overflow("overflowX")
   ...
   * MDN
   */
  final val textAlignLast = new WebStyle("textAlignLast") with TextAlign

  trait TextAlign extends WebStyle {
    /**
   ...
   * MDN
   */
  final val textAlign = new WebStyle("textAlign") with TextAlign
   ...
   * MDN
   */
  object textDecoration extends WebStyle("textDecoration") {
    /**
   ...
   * MDN
   */
  final val textIndent = new WebStyle("textIndent")
   ...
   * MDN
   */
  object textOverflow extends WebStyle("textOverflow") {
    /**
   ...
   * MDN
   */
  object textUnderlinePosition extends WebStyle("textUnderlinePosition") {
    /**
   ...
   * MDN
   */
  object textTransform extends WebStyle("textTransform") {
    /**
   ...
   * MDN
   */
  final val textShadow = new NoneOpenStyle("textShadow")

  object visibility extends WebStyle("visibility") {
    /**
   ...
   * MDN
   */
  object whiteSpace extends WebStyle("whiteSpace") {
    /**
   ...
   * MDN
   */
  final val wordSpacing = new NormalOpenStyle("wordSpacing")
  /**
   ...
   * MDN
   */
  final val zIndex = new AutoStyle("zIndex")
   ...
   * MDN
   */
  final val animationDirection = new WebStyle("animationDirection")
   ...
   * MDN
   */
  final val animationDuration = new WebStyle("animationDuration")
   ...
   * MDN
   */
  final val animationName = new WebStyle("animationName")
   ...
   * MDN
   */
  final val animationFillMode = new WebStyle("animationFillMode")
   ...
   * MDN
   */
  final val animationIterationCount = new WebStyle("animationIterationCount")
   ...
   * MDN
   */
  final val animationDelay = new MultiTimeStyle("animationDelay")
   ...
   * MDN
   */
  final val animationTimingFunction = new WebStyle("animationTimingFunction")
   ...
   * MDN
   */
  final val animationPlayState = new WebStyle("animationPlayState")
  /**
   ...
   * MDN
   */
  final val animation = new WebStyle("animation")
   ...
   * MDN
   */
  object backfaceVisibility extends WebStyle("backfaceVisibility") {
    /**
   ...
   * MDN
   */
  object columns extends WebStyle("columns") {
    def :=(number: Int, width: String): WebStylePair = this := s"$number $width"
  }
   ...
   * MDN
   */
  final val columnCount = new AutoStyle("columnCount")
   ...
   * MDN
   */
  object columnFill extends WebStyle("columnFill") {
    /**
   ...
   * MDN
   */
  final val columnGap = new NormalOpenStyle("columnGap")
   ...
   * MDN
   */
  final val columnRule = new WebStyle("columnRule")
   ...
   * MDN
   */
  object columnSpan extends WebStyle("columnSpan") {
    /**
   ...
   * MDN
   */
  final val columnWidth = new AutoStyle("columnWidth")
   ...
   * MDN
   */
  final val columnRuleColor = new WebStyle("columnRuleColor")
   ...
   * MDN
   */
  object columnRuleWidth extends WebStyle("columnRuleWidth") {
    @inline final def thin = this := "thin"
   ...
   * MDN
   */
  final val contentStyle = new WebStyle("content")
   ...
   * MDN
   */
  final val counterIncrement = new WebStyle("counterIncrement")
   ...
   * MDN
   */
  final val counterReset = new WebStyle("counterReset")
   ...
   * MDN
   */
  final val orphans = new WebStyle("orphans")
   ...
   * MDN
   */
  final val widows = new WebStyle("widows")
   ...
   * MDN
   */
  final val pageBreakAfter = new PageBreak("pageBreakAfter")
   ...
   * MDN
   */
  final val pageBreakInside = new PageBreak("pageBreakInside")
   ...
   * MDN
   */
  final val pageBreakBefore = new PageBreak("pageBreakBefore")
   ...
   * MDN
   */
  final val perspective = new NoneOpenStyle("perspective")
   ...
   * MDN
   */
  final val perspectiveOrigin = new WebStyle("perspectiveOrigin")
   ...
   * MDN
   */
  final val transitionDelay = new MultiTimeStyle("transitionDelay")
   ...
   * MDN
   */
  final val transition = new WebStyle("transition")
   ...
   * MDN
   */
  final val transitionTimingFunction = new WebStyle("transitionTimingFunction")
   ...
   * MDN
   */
  final val transitionDuration = new MultiTimeStyle("transitionDuration")
   ...
   * MDN
   */
  final val transitionProperty = new WebStyle("transitionProperty")
   ...
   * MDN
   */
  final val transform = new WebStyle("transform")
   ...
   * MDN
   */
  final val flex = new WebStyle("flex")
   ...
   * MDN
   */
  final val flexBasis = new WebStyle("flexBasis")
   ...
   * MDN
   */
  final val flexGrow = new WebStyle("flexGrow")
   ...
   * MDN
   */
  final val flexShrink = new WebStyle("flexShrink")
   ...
   * MDN
   */
  object alignContent extends WebStyle("alignContent") {
   ...
   * MDN
   */
  object alignSelf extends WebStyle("alignSelf") {
    /**
   ...
   * MDN
   */
  object flexWrap extends WebStyle("flexWrap") {
   ...
   * MDN
   */
  object alignItems extends WebStyle("alignItems") {
   ...
   * MDN
   */
  object justifyContent extends WebStyle("justifyContent") {
   ...
   * MDN
   */
  final val transformOrigin = new WebStyle("transformOrigin")
   ...
   * MDN
   */
  object transformStyle extends WebStyle("transformStyle") {
    /**
   ...
   * MDN
   */
  object unicodeBidi extends WebStyle("unicodeBidi") {
    /**
   ...
   * MDN
   */
  object wordBreak extends WebStyle("wordBreak") {
    /**
